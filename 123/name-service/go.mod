module github.com/mss-boot-io/mss-boot-monorepo/mss-boot/name

go 1.18

replace github.com/mss-boot-io/mss-boot-monorepo/mss-boot/name-proto => ../name-proto

require (
	github.com/mss-boot-io/mss-boot-monorepo/mss-boot/name-proto v0.0.0-00010101000000-000000000000
